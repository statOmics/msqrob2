...
setGeneric("nfLogMedian", function(object, na.rm = TRUE, ...) standardGeneric("nfLogMedian"))
...
setGeneric("nfLogMedianOfRatios", function(object, na.rm = TRUE, ...) standardGeneric("nfLogMedianOfRatios"))
