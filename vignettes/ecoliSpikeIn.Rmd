...
of all peptide intensities are missing and for some peptides we don't even measure a signal in any sample.
The missingness is similar across samples.
...
We will normalize the data using `vsn` normalisation. 
...
differences (log FC) in the peptide data seems to be driven by the spike-in condition.
