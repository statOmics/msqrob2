...
vignette: >
    %\VignetteIndexEntry{F. labelled workflow with method comparison}
...
grid.arrange(grobs = tprFdpPlots, ncol = 1)

for (i in 1:length(tprFdpPlots)) {
    tprFdpPlots[[i]] <- tprFdpPlots[[i]] + xlim(0, .2)
}
grid.arrange(grobs = tprFdpPlots, ncol = 1)
```
