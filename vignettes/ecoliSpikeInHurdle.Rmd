...
By default the hurdle model estimates the model parameters for the model component that models the protein intensities using robust regression.
By default, this model component is stored in the row data under name "msqrobHurdleIntensity".
The number of peptides that were used to summarize to protein level expression values are modelled using a quasibinomial model. This model component is stored by default in the row data under the name "msqrobHurdleCount".
